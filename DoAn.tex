...
\chapter{CƠ SỞ VỀ ĐIỆN TIM THAI VÀ THEO DÕI THAI NHI}
\label{chapter:FECGBackground}
\subfile{Chuong/2_FECG_BG}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{TỔNG QUAN CÁC PHƯƠNG PHÁP TÁCH fECG KHÔNG XÂM LẤN}
\label{chapter:RelatedWorks}
\subfile{Chuong/3_DL_Model}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{CƠ SỞ LÝ THUYẾT HỌC SÂU}
\label{chapter:DLBackground}
\subfile{Chuong/4_CoSoLyThuyet}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{MÔ HÌNH ĐỀ XUẤT KAN-WNETR}
\label{chapter:ProposedModel}
\subfile{Chuong/5_MoHinhDeXuat}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{DỮ LIỆU, TIỀN XỬ LÝ VÀ THIẾT LẬP THỰC NGHIỆM}
\label{chapter:DataAndSetup}
\subfile{Chuong/6_Dulieu_ThietLap}
